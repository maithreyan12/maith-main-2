    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.socials}>
          ...
          >
            <img src="/assets/email.webp" alt="Email Maithreyan D" loading="lazy" decoding="async" />
          </a>
          <a
          ...
          >
            <img src="/assets/linkedin.webp" alt="Maithreyan D LinkedIn" loading="lazy" decoding="async" />
          </a>
          <a
            href={AUTHOR.github}
          ...
          >
            <img src="/assets/github.webp" alt="Maithreyan D GitHub" loading="lazy" decoding="async" />
          </a>
          <a
