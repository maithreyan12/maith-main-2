  ...
  return (
    <section id="contact" ref={ref} className={styles.contact}>
      ...
      >
        ...
        >
          <img src="/assets/email.webp" alt="Email" className={styles.infoIcon} loading="lazy" decoding="async" />
        ...
        <motion.a
          ...
          transition={{ type: "spring", stiffness: 380, damping: 22 }}
        >
          <img src="/assets/linkedin.webp" alt="Maithreyan D LinkedIn" className={styles.infoIcon} loading="lazy" decoding="async" />
          <span>LinkedIn</span>
        </motion.a>
        <motion.a
